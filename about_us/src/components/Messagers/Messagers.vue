<template>
    <div class="team-list__item-messagers">
        <a v-for="messager in messagers" :key="messager.type" :href="link(messager)">
            <TelegramLogo v-if="messager.type === 'tg' && messager.number"/>
            <ViberLogo v-if="messager.type === 'viber' && messager.number"/>
            <WhatsappLogo v-if="messager.type === 'whatsapp' && messager.number"/>
        </a>
    </div>
</template>

<script>
    import TelegramLogo from '../../../../equipment_rental/src/assets/svg/TelegramLogo.vue';
    import ViberLogo from '../../../../equipment_rental/src/assets/svg/ViberLogo.vue';
    import WhatsappLogo from '../../../../equipment_rental/src/assets/svg/WhatsappLogo.vue';
